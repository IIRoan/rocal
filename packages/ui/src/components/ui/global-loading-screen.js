...
export function GlobalLoadingScreen({ isLoading = true, message = "Loading...", variant = "detailed", className }) {
    ...
    if (!isLoading)
        return null;
    if (variant === "minimal") {
        return (<div className={cn("fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm", className)}>
    ...
    if (variant === "splash") {
        return (<div className={cn("fixed inset-0 z-50 flex flex-col items-center justify-center bg-background", className)}>
    ...
    return (<div className={cn("fixed inset-0 z-50 flex items-center justify-center bg-background/90 backdrop-blur-sm", className)}>
      <div className="flex flex-col items-center space-y-6 max-w-md mx-auto px-4">
        {/* Main Spinner */}
        <div className="relative">
...
export function SectionLoading({ title = "Loading", description = "Please wait...", className }) {
    return (<div className={cn("flex flex-col items-center justify-center p-8 text-center space-y-4", className)}>
      <div className="h-8 w-8 animate-spin rounded-full border-2 border-primary/30 border-t-primary"/>
      <div className="space-y-2">
...
export function LoadingOverlay({ isLoading = false, children, message = "Loading...", className }) {
    return (<div className={cn("relative", className)}>
      {children}
      {isLoading && (<div className="absolute inset-0 z-10 flex items-center justify-center bg-background/80 backdrop-blur-sm rounded-lg">
          <div className="flex items-center space-x-2">
