...
function Input({ className, type, animated = true, ...props }) {
    return (<input type={type} data-slot="input" className={cn(
        ...
        type === "search" &&
            "[&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-decoration]:appearance-none [&::-webkit-search-results-button]:appearance-none [&::-webkit-search-results-decoration]:appearance-none", className)} {...props}/>);
}
export { Input };
