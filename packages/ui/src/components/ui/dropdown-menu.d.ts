...
declare function DropdownMenuContent({ className, sideOffset, onPointerDown, onPointerDownOutside, onCloseAutoFocus, ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Content>): React.JSX.Element;
