...
import { Calendar, Users, Zap, Shield, Globe, BarChart3, Smartphone, Clock, CheckCircle, } from "lucide-react";
...
export function FeaturesSection() {
    return (<section id="features" className="py-24 px-6 bg-muted/20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (<Card key={feature.title} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 bg-card/60 backdrop-blur-sm border border-border/50 relative overflow-hidden hover:border-primary/20" style={{
              ...
              <CardContent className="p-8 relative z-10">
                <div className="flex flex-col items-start gap-6">
                  <div className={`p-4 rounded-2xl ${feature.bgColor} group-hover:scale-125 group-hover:rotate-3 transition-all duration-500 shadow-lg group-hover:shadow-xl`}>
