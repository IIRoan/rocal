        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary to-accent p-1">
          ...
          <div className="relative rounded-3xl bg-background p-12 md:p-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link href="/dashboard">
                <Button size="lg" className="rounded-full px-8 py-4 text-lg font-medium shadow-lg bg-primary hover:bg-primary/90 text-primary-foreground group">
                  Start Free Today
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform"/>
                </Button>
              </Link>
              <Button variant="outline" size="lg" className="rounded-full px-8 py-4 text-lg font-medium border-2">
                Schedule a Demo
              </Button>
            </div>
