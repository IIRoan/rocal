            ...
            <Card
              ...
              className={`relative group transition-all duration-500 ${
                plan.popular
                  ...
                  : "hover:-translate-y-3 hover:shadow-2xl bg-card/60"
              } backdrop-blur-sm border border-border/50 hover:border-primary/20 overflow-hidden`}
              style={{
            ...
            >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className={`text-5xl font-bold transition-colors duration-300 ${
                      plan.popular ? "text-primary" : "text-foreground group-hover:text-primary"
                    }`}>
                      {plan.price}
                    </span>
                    {plan.price !== "Free" && (
              ...
              <CardContent className="space-y-8 relative z-10">
                ...
                <Link href={plan.href} className="block">
                  <Button
                    className={`w-full rounded-xl font-semibold py-4 text-lg group transition-all duration-300 hover:scale-105 ${
                      plan.popular
