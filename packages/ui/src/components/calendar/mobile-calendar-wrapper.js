...
export function MobileCalendarWrapper({ user, onLogout, onOpenSettings, onOpenCalendarManagement, onOpenAddEvent, children, className, ...props }) {
    ...
    return (<div className="relative flex flex-col h-full">
      ...
      <MobileWeekNav currentDate={currentDate} currentView={currentView} onDateChange={handleDateChange} className="md:hidden"/>
      ...
      <MobileBottomNav onOpenSidebar={handleOpenSidebar} onOpenAddEvent={handleOpenAddEvent} currentView={currentView} onViewChange={handleViewChange} className="md:hidden"/>
      ...
      <Sheet open={isSidebarOpen} onOpenChange={setIsSidebarOpen}>
        <SheetContent side="left" className="w-80 p-0">
          ...
          <SidebarProvider defaultOpen={true}>
            <AppSidebar user={user} onLogout={onLogout} onOpenSettings={handleOpenSettings} onOpenCalendarManagement={onOpenCalendarManagement} isMobile={true}/>
          </SidebarProvider>
        </SheetContent>
      </Sheet>
    </div>);
