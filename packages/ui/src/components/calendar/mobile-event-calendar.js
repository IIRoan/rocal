...
import { addDays, addMonths, addWeeks, endOfWeek, format, isSameMonth, startOfWeek, subMonths, subWeeks, startOfMonth, endOfMonth, } from "date-fns";
...
export function MobileEventCalendar({ className, initialView = "month", events = [], categories = [], loading = false, eventsLoading = false, error = null, onCreateEvent, onUpdateEvent, onDeleteEvent, onCreateCategory, onDateRangeChange, showWeekNumbers = false, compactView = false, timeFormat = "24h", defaultReminder = null, defaultEventDuration = 60, defaultCalendarId = null, weekStartDay = 1, workingDays = [1, 2, 3, 4, 5], timezone, themeSettings, onLoadNotifications, onUpdateNotifications, onEventEdit, onSidebarToggle, onViewChange, }) {
      ...
      <div className="flex has-data-[slot=month-view]:flex-1 flex-col rounded-lg" style={{
        ...
        <CalendarDndProvider onEventUpdate={handleEventUpdate} timezone={timezone}>
          ...
          <div className="flex flex-1 flex-col">
            ...
            {view === "day" && (<DayView currentDate={currentDate} events={events} onEventSelect={handleEventSelect} onEventCreate={handleEventCreate} compactView={compactView} timeFormat={timeFormat} workingDays={workingDays} timezone={timezone}/>)}
            {view === "agenda" && (<AgendaView currentDate={currentDate} events={events} onEventSelect={handleEventSelect} onEventCreate={handleEventCreate} timeFormat={timeFormat} timezone={timezone}/>)}
          </div>
        </CalendarDndProvider>
      </div>
    </ErrorBoundary>);
