import { RiExpandUpDownLine, RiGroupLine, RiLogoutCircleLine, } from "@remixicon/react";
...
export function NavUser({ user, onLogout, onOpenSettings, }) {
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton size="lg" className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground [&>svg]:size-5">
          ...
          <DropdownMenuContent className="w-(--radix-dropdown-menu-trigger-width) bg-sidebar" side="bottom" align="end" sideOffset={4}>
            <DropdownMenuGroup>
              <DropdownMenuItem className="gap-3 focus:bg-sidebar-accent" onClick={onOpenSettings}>
