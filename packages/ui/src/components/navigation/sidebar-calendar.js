...
export function SidebarCalendar({ className }) {
    ...
    return (<div className={cn("w-full flex justify-center", className)}>
      <Calendar mode="single" selected={currentDate} onSelect={handleSelect} month={calendarMonth} onMonthChange={handleMonthChange} classNames={{
