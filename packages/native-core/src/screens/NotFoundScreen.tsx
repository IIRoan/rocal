...
import {
  AUTH_SIGN_IN_ROUTE,
  SETTINGS_ROUTE,
} from "@workspace/native-core/lib/auth-routing";
...
export function NotFoundScreen({
  ...
  homeRoute: string;
  /** App name shown on the primary button, e.g. "Calendar". */
  homeLabel: string;
}) {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.actions}>
          <Pressable
            ...
            accessibilityLabel={`Go to ${homeLabel.toLowerCase()}`}
          >
            <Text style={styles.primaryButtonText}>Go to {homeLabel}</Text>
          </Pressable>
