...
export const darkTheme: ThemeTokens = {
  colors: {
    ...
    calendar: {
      blue: { bg: "oklch(0.55 0.18 250)", fg: "oklch(0.92 0.04 250)" },
      orange: { bg: "oklch(0.55 0.18 65)", fg: "oklch(0.92 0.04 65)" },
      violet: { bg: "oklch(0.55 0.18 285)", fg: "oklch(0.92 0.04 285)" },
      rose: { bg: "oklch(0.55 0.18 15)", fg: "oklch(0.92 0.04 15)" },
      emerald: { bg: "oklch(0.55 0.18 150)", fg: "oklch(0.92 0.04 150)" },
      red: { bg: "oklch(0.55 0.18 30)", fg: "oklch(0.92 0.04 30)" },
      cyan: { bg: "oklch(0.55 0.18 205)", fg: "oklch(0.92 0.04 205)" },
      lime: { bg: "oklch(0.55 0.18 135)", fg: "oklch(0.92 0.04 135)" },
      amber: { bg: "oklch(0.55 0.18 85)", fg: "oklch(0.92 0.04 85)" },
      indigo: { bg: "oklch(0.55 0.18 270)", fg: "oklch(0.92 0.04 270)" },
      pink: { bg: "oklch(0.55 0.18 345)", fg: "oklch(0.92 0.04 345)" },
      teal: { bg: "oklch(0.55 0.18 175)", fg: "oklch(0.92 0.04 175)" },
    },
  },
  spacing,
  typography,
