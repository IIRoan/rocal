...
export function SettingToggleRow({
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className="flex w-full cursor-pointer items-center gap-3 rounded-md px-3 py-2 text-left transition-colors hover:bg-accent/30 focus:bg-accent/50 focus:outline-none"
    >
