...
export function NotificationSettings({ open, onOpenChange, localSettings, updateSetting, goBack, TransitionContainer, transitionDirection, }) {
      ...
      <TransitionContainer direction={transitionDirection}>
        ...
        <CommandList>
          <CommandGroup heading="Notification Types">
            <CommandItem onSelect={() => updateSetting("emailNotifications", !localSettings.emailNotifications)} className="px-4 py-3 hover:bg-accent/20 data-[selected=true]:bg-accent/30">
          ...
          <CommandGroup heading="Default Reminder">
            <div className="px-4 py-3">
              <div className="flex flex-col gap-3">
                ...
                <Input type="number" value={localSettings.defaultReminder || ""} onChange={(e) => updateSetting("defaultReminder", e.target.value ? parseInt(e.target.value) : null)} placeholder="No default reminder" min={1} max={43200} className="w-full"/>
              </div>
            </div>
          </CommandGroup>
        </CommandList>
