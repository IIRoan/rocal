...
import { EventCalendar, AgendaDaysToShow, useCalendarContext, CalendarSkeleton, } from "@workspace/ui/components/calendar";
import { addDays, startOfWeek, endOfWeek, startOfMonth, endOfMonth, } from "date-fns";
import { useSharedCalendarData } from "@/components/calendar-data-provider";
import { useSettings } from "@/hooks/use-settings";
import { useCommandPalette } from "./command-palette-context";
import { PageLoadingOverlay } from "@workspace/ui/components/ui";
export function CalendarWithData({ className }) {
    ...
    if (isAllInitialLoading) {
        ...
        <PageLoadingOverlay isLoading={true} messageContext={overlayContext} enableCycling={true}/>
      </>);
    }
