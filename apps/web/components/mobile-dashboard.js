...
export function MobileDashboard({ user, onLogout }) {
    ...
    return (<>
      ...
      <div className="hidden md:flex h-screen">
        <SidebarProvider>
          <AppSidebar user={user} onLogout={onLogout} onOpenSettings={openPalette} onOpenCalendarManagement={openCalendarManagement}/>
          <SidebarInset>
            <CalendarWithData />
          </SidebarInset>
        </SidebarProvider>
