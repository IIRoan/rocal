...
const iosBundleIdentifier = isDev ? "onl.solace.mail.dev" : "onl.solace.mail";
...
const baseConfig = {
  name: isDev ? "Mail Dev" : "Solace Mail",
  slug: "solace-mail",
  version: "1.0.0",
  ...
  android: {
    package: isDev ? "onl.solace.mail.dev" : "onl.solace.mail",
    versionCode: 1,
    adaptiveIcon: {
  ...
  extra: {
    eas: {
      projectId: "abe3e4a0-5b68-47b4-9390-654d95f093bd",
      build: {
        experimental: {
          ios: {
            appExtensions: [
