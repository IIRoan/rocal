module.exports = {
  ...
  moduleNameMapper: {
    "^@/(.*)$": "<rootDir>/$1",
    "^@workspace/design-tokens$": "<rootDir>/../../packages/design-tokens/src/index.ts",
    "^@workspace/design-tokens/(.*)$": "<rootDir>/../../packages/design-tokens/src/$1",
    ...
    "^@workspace/calendar-client$": "<rootDir>/../../packages/calendar-client/src/index.ts",
    "^@workspace/calendar-client/(.*)$": "<rootDir>/../../packages/calendar-client/src/$1",
