...
export const CalendarRelations = t.Object({
    ...
    sharedCalendars: t.Array(t.Object({
        id: t.String(),
        calendarId: t.String(),
        sharedWith: t.String(),
        sharedBy: t.String(),
...
export const CalendarRelationsInputCreate = t.Object({
    ...
    sharedCalendars: t.Optional(t.Object({
        connect: t.Array(t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }), { additionalProperties: false }),
    }, { additionalProperties: false })),
...
export const CalendarRelationsInputUpdate = t.Partial(t.Object({
    user: t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
    ...
    sharedCalendars: t.Partial(t.Object({
        connect: t.Array(t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }), { additionalProperties: false }),
        disconnect: t.Array(t.Object({
...
export const CalendarWhere = t.Partial(t.Recursive((Self) => t.Object({
    ...
    createdAt: t.Date(),
    updatedAt: t.Date(),
}, { additionalProperties: false }), { $id: "Calendar" }));
export const CalendarWhereUnique = t.Recursive((Self) => t.Intersect([
    t.Partial(t.Object({
        id: t.String(),
...
export const CalendarSelect = t.Partial(t.Object({
    id: t.Boolean(),
    name: t.Boolean(),
    color: t.Boolean(),
    isVisible: t.Boolean(),
...
export const CalendarInclude = t.Partial(t.Object({
    user: t.Boolean(),
    events: t.Boolean(),
    sharedCalendars: t.Boolean(),
    subscriptions: t.Boolean(),
...
export const CalendarOrderBy = t.Partial(t.Object({
...
export const CalendarInputCreate = t.Composite([CalendarPlainInputCreate, CalendarRelationsInputCreate], { additionalProperties: false });
export const CalendarInputUpdate = t.Composite([CalendarPlainInputUpdate, CalendarRelationsInputUpdate], { additionalProperties: false });
