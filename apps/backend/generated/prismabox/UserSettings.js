...
export const UserSettingsRelationsInputUpdate = t.Partial(t.Object({
    user: t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
...
export const UserSettingsWhere = t.Partial(t.Recursive((Self) => t.Object({
    ...
    createdAt: t.Date(),
    updatedAt: t.Date(),
}, { additionalProperties: false }), { $id: "UserSettings" }));
export const UserSettingsWhereUnique = t.Recursive((Self) => t.Intersect([
    t.Partial(t.Object({ id: t.String(), userId: t.String() }, { additionalProperties: false }), { additionalProperties: false }),
    t.Union([t.Object({ id: t.String() }), t.Object({ userId: t.String() })], { additionalProperties: false }),
    t.Partial(t.Object({
        AND: t.Union([
            Self,
...
export const UserSettingsSelect = t.Partial(t.Object({
    id: t.Boolean(),
    userId: t.Boolean(),
    user: t.Boolean(),
    theme: t.Boolean(),
...
export const UserSettingsInclude = t.Partial(t.Object({ user: t.Boolean(), _count: t.Boolean() }, { additionalProperties: false }));
export const UserSettingsOrderBy = t.Partial(t.Object({
...
export const UserSettings = t.Composite([UserSettingsPlain, UserSettingsRelations], { additionalProperties: false });
export const UserSettingsInputCreate = t.Composite([UserSettingsPlainInputCreate, UserSettingsRelationsInputCreate], { additionalProperties: false });
export const UserSettingsInputUpdate = t.Composite([UserSettingsPlainInputUpdate, UserSettingsRelationsInputUpdate], { additionalProperties: false });
