...
export const EventNotificationRelationsInputUpdate = t.Partial(t.Object({
    event: t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
...
export const EventNotificationWhere = t.Partial(t.Recursive((Self) => t.Object({
    ...
    createdAt: t.Date(),
    updatedAt: t.Date(),
}, { additionalProperties: false }), { $id: "EventNotification" }));
export const EventNotificationWhereUnique = t.Recursive((Self) => t.Intersect([
...
export const EventNotificationSelect = t.Partial(t.Object({
    id: t.Boolean(),
    eventId: t.Boolean(),
    event: t.Boolean(),
...
export const EventNotificationInclude = t.Partial(t.Object({ event: t.Boolean(), _count: t.Boolean() }, { additionalProperties: false }));
export const EventNotificationOrderBy = t.Partial(t.Object({
...
export const EventNotification = t.Composite([EventNotificationPlain, EventNotificationRelations], { additionalProperties: false });
export const EventNotificationInputCreate = t.Composite([EventNotificationPlainInputCreate, EventNotificationRelationsInputCreate], { additionalProperties: false });
export const EventNotificationInputUpdate = t.Composite([EventNotificationPlainInputUpdate, EventNotificationRelationsInputUpdate], { additionalProperties: false });
