...
export const CalendarEventRelations = t.Object({
    ...
    category: __nullable__(t.Object({
        id: t.String(),
        name: t.String(),
        color: t.String(),
        isActive: t.Boolean(),
    ...
    recurrenceExceptions: t.Array(t.Object({
        id: t.String(),
...
export const CalendarEventRelationsInputCreate = t.Object({
    ...
    category: t.Optional(t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
    }, { additionalProperties: false })),
    participants: t.Optional(t.Object({
        connect: t.Array(t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }), { additionalProperties: false }),
    }, { additionalProperties: false })),
    recurrenceExceptions: t.Optional(t.Object({
        connect: t.Array(t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }), { additionalProperties: false }),
    }, { additionalProperties: false })),
...
export const CalendarEventRelationsInputUpdate = t.Partial(t.Object({
    user: t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
    ...
    category: t.Partial(t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
        disconnect: t.Boolean(),
    }, { additionalProperties: false })),
    participants: t.Partial(t.Object({
        connect: t.Array(t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }), { additionalProperties: false }),
    ...
    recurrenceExceptions: t.Partial(t.Object({
        connect: t.Array(t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }), { additionalProperties: false }),
        disconnect: t.Array(t.Object({
    ...
    notifications: t.Partial(t.Object({
        connect: t.Array(t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }), { additionalProperties: false }),
        disconnect: t.Array(t.Object({
...
export const CalendarEventWhere = t.Partial(t.Recursive((Self) => t.Object({
    ...
    createdAt: t.Date(),
    updatedAt: t.Date(),
}, { additionalProperties: false }), { $id: "CalendarEvent" }));
export const CalendarEventWhereUnique = t.Recursive((Self) => t.Intersect([
...
export const CalendarEventSelect = t.Partial(t.Object({
    id: t.Boolean(),
    title: t.Boolean(),
...
export const CalendarEventInclude = t.Partial(t.Object({
    user: t.Boolean(),
    calendar: t.Boolean(),
    category: t.Boolean(),
    participants: t.Boolean(),
...
export const CalendarEventOrderBy = t.Partial(t.Object({
...
export const CalendarEvent = t.Composite([CalendarEventPlain, CalendarEventRelations], { additionalProperties: false });
export const CalendarEventInputCreate = t.Composite([CalendarEventPlainInputCreate, CalendarEventRelationsInputCreate], { additionalProperties: false });
export const CalendarEventInputUpdate = t.Composite([CalendarEventPlainInputUpdate, CalendarEventRelationsInputUpdate], { additionalProperties: false });
