...
export const EventNotificationPlainInputCreate = t.Object(
  {
    ...
    notificationTime: t.Date(),
    notificationDateLocal: t.String(),
    notificationTimezone: t.Optional(t.String()),
...
export const EventNotificationPlainInputUpdate = t.Object(
  {
    ...
    notificationDateLocal: t.Optional(t.String()),
    notificationTimezone: t.Optional(t.String()),
    isEnabled: t.Optional(t.Boolean()),
    isSent: t.Optional(t.Boolean()),
  },
  ...
  t.Object(
    {
      ...
      notificationDateLocal: t.Boolean(),
      notificationTimezone: t.Boolean(),
      isEnabled: t.Boolean(),
      isSent: t.Boolean(),
      createdAt: t.Boolean(),
      updatedAt: t.Boolean(),
  ...
  t.Object(
    {
      ...
      notificationDateLocal: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      notificationTimezone: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
