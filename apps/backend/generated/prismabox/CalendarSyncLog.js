...
export const CalendarSyncLogRelationsInputUpdate = t.Partial(t.Object({
    subscription: t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
...
export const CalendarSyncLogWhere = t.Partial(t.Recursive((Self) => t.Object({
    ...
    startedAt: t.Date(),
    completedAt: t.Date(),
}, { additionalProperties: false }), { $id: "CalendarSyncLog" }));
export const CalendarSyncLogWhereUnique = t.Recursive((Self) => t.Intersect([
...
export const CalendarSyncLogSelect = t.Partial(t.Object({
    id: t.Boolean(),
...
export const CalendarSyncLogInclude = t.Partial(t.Object({ subscription: t.Boolean(), _count: t.Boolean() }, { additionalProperties: false }));
export const CalendarSyncLogOrderBy = t.Partial(t.Object({
...
export const CalendarSyncLog = t.Composite([CalendarSyncLogPlain, CalendarSyncLogRelations], { additionalProperties: false });
export const CalendarSyncLogInputCreate = t.Composite([CalendarSyncLogPlainInputCreate, CalendarSyncLogRelationsInputCreate], { additionalProperties: false });
export const CalendarSyncLogInputUpdate = t.Composite([CalendarSyncLogPlainInputUpdate, CalendarSyncLogRelationsInputUpdate], { additionalProperties: false });
