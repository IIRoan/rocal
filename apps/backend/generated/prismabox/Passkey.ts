...
export const PasskeyRelationsInputUpdate = t.Partial(
  t.Object(
    {
      user: t.Object(
        {
...
export const PasskeyWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const PasskeyWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const PasskeySelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
      name: t.Boolean(),
...
export const PasskeyInclude = t.Partial(
  t.Object(
...
export const PasskeyOrderBy = t.Partial(
  t.Object(
    {
...
export const PasskeyInputCreate = t.Composite(
  [PasskeyPlainInputCreate, PasskeyRelationsInputCreate],
  { additionalProperties: false },
);

export const PasskeyInputUpdate = t.Composite(
  [PasskeyPlainInputUpdate, PasskeyRelationsInputUpdate],
  { additionalProperties: false },
);
