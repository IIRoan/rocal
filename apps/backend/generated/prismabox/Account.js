...
export const AccountRelationsInputUpdate = t.Partial(t.Object({
    user: t.Object({
        connect: t.Object({
            id: t.String({ additionalProperties: false }),
        }, { additionalProperties: false }),
...
export const AccountWhere = t.Partial(t.Recursive((Self) => t.Object({
...
export const AccountWhereUnique = t.Recursive((Self) => t.Intersect([
    t.Partial(t.Object({
        id: t.String(),
        providerId_accountId: t.Object({ providerId: t.String(), accountId: t.String() }, { additionalProperties: false }),
...
export const AccountSelect = t.Partial(t.Object({
    id: t.Boolean(),
    accountId: t.Boolean(),
...
export const AccountInclude = t.Partial(t.Object({ user: t.Boolean(), _count: t.Boolean() }, { additionalProperties: false }));
export const AccountOrderBy = t.Partial(t.Object({
...
export const AccountInputCreate = t.Composite([AccountPlainInputCreate, AccountRelationsInputCreate], { additionalProperties: false });
export const AccountInputUpdate = t.Composite([AccountPlainInputUpdate, AccountRelationsInputUpdate], { additionalProperties: false });
