import { Body, Container, Head, Heading, Html, Preview, Section, Text, Font, } from "@react-email/components";
import * as React from "react";
export const EventReminderEmail = ({ eventTitle = "Sample Event", eventDate = "January 1, 2024", eventTime = "9:00 AM", eventLocation, categoryName, categoryColor = "blue", description, timeUntilEvent = "in 15 minutes", duration, reminderText, userName, userEmail, userTheme = "light", }) => {
    ...
    const getCategoryAccentColor = (color) => {
        const colorMap = {
