---
name: paper-design
description: Use this skill whenever design-system guidance is needed for Paper Design. Follow the foundations and component rules to create practical, implementation-ready guidelines for engineers and designers.
---
