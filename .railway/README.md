...
The Solace project is defined in `.railway/railway.ts`. That file is the source of truth for services, databases, volumes, buckets, domains, and variables. Mail (`apps/stalwart`), Monitoring (`apps/gatus`), and error tracking (`apps/errex`) live in this repo; do not point those services at a second GitHub repository.
